					...
					{connected && (
						...
						>
							...
							>
								...
								>
									<span className="absolute inset-0 rounded-[inherit] bg-[radial-gradient(circle_at_25%_30%,rgba(96,165,250,0.45),transparent_60%),radial-gradient(circle_at_70%_25%,rgba(74,222,128,0.4),transparent_55%),radial-gradient(circle_at_50%_80%,rgba(244,114,182,0.45),transparent_58%)] blur-3xl opacity-80 mix-blend-screen" />
								</motion.span>
								<Button
				...
				>
					<AnimatePresence>
						{connectHovered && (
							...
							>
								<motion.span
									className="absolute inset-0 rounded-[45%] bg-[radial-gradient(circle_at_20%_20%,rgba(74,222,128,0.48),transparent_60%),radial-gradient(circle_at_80%_25%,rgba(59,130,246,0.45),transparent_55%),radial-gradient(circle_at_50%_80%,rgba(192,132,252,0.52),transparent_60%)] blur-2xl opacity-90 mix-blend-screen"
									animate={{
